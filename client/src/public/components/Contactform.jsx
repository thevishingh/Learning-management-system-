...
export default function ContactUs1() {
  ...
  return (
    <section className="bg-background bg-top relative w-full overflow-hidden py-16 md:py-24">
      <div
          ...
          <div className="grid md:grid-cols-2">
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              <motion.form
                ...
                className="mt-8 space-y-6 font-mont"
              >
                ...
                >
                  <Button
                    ...
                    className="w-full font-mont bg-gradient-to-b from-rose-500 to-rose-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
                  >
                    {isSubmitting ? (
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#e60a64] to-[#e60a64]/5 p-6 text-3xl tracking-tight font-mont-alt text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
